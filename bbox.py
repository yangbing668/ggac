...
if __name__ == "__main__":
    ...
    model_name = '/home/yb/桌面/code/ImageGCN/models/all/best_singlealex_relation_RGB_tr0.7_partly_norm.pth.tar'
    ...
    with torch.no_grad():
        for i, data in enumerate(bbox_loader):
            ...
            cv2.imwrite('/home/yb/桌面/code/ImageGCN/heatmaps/' + 'label' + str(label) + '_' + name, heatmap)
            image.save('/home/yb/桌面/code/ImageGCN/bbox/' + 'label' + str(label) + '_' + name)
    ...
    pd.concat(res_iou, axis=1).to_csv('/home/user/桌面/code/ImageGCN/bbox_res/res_iou.csv')
    pd.concat(res_iobb, axis=1).to_csv('/home/user/桌面/code/ImageGCN/bbox_res/res_iobb.csv')
    bbox.to_csv('/home/user/桌面/code/ImageGCN/bbox_res/bbox_detect.csv')
