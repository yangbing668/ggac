...
parser.add_argument('-e','--encoder', default='dens121', type=str, help='the encoder')#res50 alex  vgg16bn
parser.add_argument('-r','--relations', default='all', type=str, help='the considered relations, pid, age, gender, view')
parser.add_argument('--pps', default='my', type=str, help='the parameter sharing method (default partly)')#totally
